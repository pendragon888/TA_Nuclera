...
| Projects    	| I've assessed this as high priority due to the importance of this feature for automation. The coverage here, ensures admin has the permissions to create a new project, add items to it and assign members.<br><br>As a regular user, I can access the project, add items and check they can't view the members section                                                                                                                                                                                            	|
| Users       	| Admin user only have access to this screen and can add and remove users.<br><br>As a regular user, this page is not visible. A **loginPage.spec.ts** test checks for this condition.                                                                                                                                                                                                                                                  	|
